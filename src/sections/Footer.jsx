...
export default function Footer() {
  return (
    <footer
      id="footer"
      className="relative z-10 pt-20 pb-10 border-t border-white/[0.05]"
      style={{
        paddingTop: 'clamp(24px, 6vw, 100px)',
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div className="text-center mb-20"
          ...
          <p className="text-white/50 text-xl font-medium mb-8" style={{ fontFamily: 'Satoshi, sans-serif' }}>
